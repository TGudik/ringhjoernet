...
export default function CookieTerms() {
    ...
    return (
      <div style={{ maxWidth: 1140, margin: "80px auto" }}>
        <h2>Cookie- og privatlivspolitik hos Ringhjørnet</h2>
        <br />
        <h3>Introduktion</h3>
        <br />
        <p>
        ...
        <p>
          ...
          persondataforordningen og databeskyttelsesloven. <br />
          ...
          ikke længere relevant. Vi har truffet tekniske og organisatoriske
        ...
        <p>
          ...
          email@ringhjørnet.dk. Hvis du vil klage over vores behandling af dine
          personoplysninger, har du også mulighed for at tage kontakt til
          Datatilsynet. <br /> Ønsker du ikke længere, at vi skal behandle dine
